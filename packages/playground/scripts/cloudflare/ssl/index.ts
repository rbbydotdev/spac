...
export function registerSsl(api: Api) {
  ...
  api.group("/zones/{zone_id}/ssl", { params: Type.Object({ zone_id: Type.String() }) }, (g) => {
    g.post("/analyze", {
      ...
      .response(TlsCertificatesAndHostnamesCertificateAnalyzeResponse)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.get("/certificate_packs", {
      ...
      .response(TlsCertificatesAndHostnamesCertificatePackResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.post("/certificate_packs/order", {
      ...
      .response(TlsCertificatesAndHostnamesAdvancedCertificatePackResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.get("/certificate_packs/quota", {})
      .response(TlsCertificatesAndHostnamesCertificatePackQuotaResponse)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.delete("/certificate_packs/{certificate_pack_id}", {
      ...
      .response(TlsCertificatesAndHostnamesKeylessResponseSingleId)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.get("/universal/settings", {})
      .response(TlsCertificatesAndHostnamesSslUniversalSettingsResponse)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.get("/verification", {
      ...
      .response(TlsCertificatesAndHostnamesSslVerificationResponseCollection)
      .error(
        "4XX",
        Type.Object({
          result: Type.Union([Type.Null()]),
    ...
    g.patch("/verification/{certificate_pack_id}", {
      ...
      .response(TlsCertificatesAndHostnamesSslValidationMethodResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
