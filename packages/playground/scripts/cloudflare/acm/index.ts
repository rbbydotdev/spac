...
export function registerAcm(api: Api) {
  ...
  api.group("/zones/{zone_id}/acm", { params: Type.Object({ zone_id: Type.String() }) }, (g) => {
    g.get("/custom_trust_store", {
      ...
      .response(TlsCertificatesAndHostnamesCustomTrustStoreResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.post("/custom_trust_store", {
      ...
      .response(TlsCertificatesAndHostnamesCustomTrustStoreResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.get("/total_tls", {})
      .response(TlsCertificatesAndHostnamesTotalTlsSettingsResponse)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
