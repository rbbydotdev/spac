...
export function registerRealtimekit(api: Api) {
  api.assertVersion("3.0.3", "Realtimekit")
  ...
  api.group("/accounts/{account_id}/realtimekit", { params: Type.Object({ account_id: Type.String() }) }, (g) => {
    ...
    g.get("/meetings/{meeting_id}", {
      ...
      .error(500, RealtimekitGenericerrorresponse)
    ...
    g.get("/meetings/{meeting_id}/active-session", {
      ...
      .error(404, RealtimekitGenericerrorresponse)
              ...
              livestreams: Type.Optional(
                Type.Array(
                  Type.Object({
                    ...
                    stream_key: Type.Optional(
                      Type.String({ description: "Unique key for accessing each livestream." }),
                    ),
                    updated_at: Type.Optional(
                      Type.String({
                        description:
    ...
    g.get("/orgs", {
      ...
      .response(RealtimekitOrganizationlistsuccessresponse)
      .error(400, RealtimekitErrorresponse)
      .error(401, RealtimekitErrorresponse)
    ...
    g.post("/orgs", {
      ...
      .respond(201, RealtimekitOrganizationsuccessresponse)
      .error(400, RealtimekitErrorresponse)
      .error(401, RealtimekitErrorresponse)
      .error(409, RealtimekitErrorresponse)
    ...
    g.get("/orgs/{org_id}", {
      ...
      .response(RealtimekitOrganizationsuccessresponse)
      .error(400, RealtimekitErrorresponse)
      .error(401, RealtimekitErrorresponse)
          ...
          data: Type.Object(
            {
              ...
              config: Type.Object({
                ...
                view_type: Type.Union(
                  [Type.Literal("GROUP_CALL"), Type.Literal("WEBINAR"), Type.Literal("AUDIO_ROOM")],
    ...
    g.post("/webhooks", {
      ...
      .respond(201, RealtimekitWebhooksuccessresponse)
      .error(400, RealtimekitErrorresponse)
    ...
    g.get("/webhooks/{webhook_id}", {
      ...
      .response(RealtimekitWebhooksuccessresponse)
      .error(400, RealtimekitErrorresponse)
