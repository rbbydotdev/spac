...
export function registerRules(api: Api) {
  ...
  api.group("/accounts/{account_id}/rules/lists", { params: Type.Object({ account_id: Type.String() }) }, (g) => {
    ...
    g.post("/", {
      ...
      .response(ListsListResponseCollection)
      .error(
        "4XX",
        Type.Object({
    ...
    g.get("/bulk_operations/{operation_id}", {
      ...
      .response(ListsBulkOperationResponseSingle)
      .error(
        "4XX",
        Type.Object({
          result: Type.Union([
    ...
    g.delete("/{list_id}", {
      ...
      .response(ListsListDeleteResponseCollection)
      .error(
        "4XX",
        Type.Object({
          result: Type.Union([Type.Null()]),
    ...
    g.get("/{list_id}/items", {
      ...
      .response(ListsItemsListResponseCollection)
      .error(
        "4XX",
        Type.Object({
          result: Type.Union([Type.Null()]),
    ...
    g.post("/{list_id}/items", {
      ...
      .response(ListsListsAsyncResponse)
      .error(
        "4XX",
        Type.Object({
    ...
    g.get("/{list_id}/items/{item_id}", {
      ...
      .response(ListsItemResponseSingle)
      .error(
        "4XX",
        Type.Object({
          result: Type.Union([
