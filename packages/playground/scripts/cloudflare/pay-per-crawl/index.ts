...
export function registerPayPerCrawl(api: Api) {
  api.assertVersion("3.0.3", "PayPerCrawl")

  api
    .get("/accounts/{account_id}/pay-per-crawl/crawler/stripe", {
      params: Type.Object({ account_id: Type.String() }),
    })
    .response(PayPerCrawlGetstripeconfigresponse)
    .error(400, PayPerCrawlApierrorresponse)
  ...
  api
    ...
    .response(PayPerCrawlCreatestripeconfigresponse)
    .error(400, PayPerCrawlApierrorresponse)
  ...
  api
    ...
    .response(PayPerCrawlApinoresultresponse)
    .error(400, PayPerCrawlApierrorresponse)
  ...
  api
    ...
    .response(PayPerCrawlQueryzonescanbeenabledresponse)
    .error(400, PayPerCrawlApierrorresponse)
  ...
  api
    ...
    .response(PayPerCrawlGetconfigresponse)
    .error(400, PayPerCrawlApierrorresponse)
