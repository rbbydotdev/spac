...
export function registerTeamnet(api: Api) {
  api.assertVersion("3.0.3", "Teamnet")
  ...
  api.group("/accounts/{account_id}/teamnet", { params: Type.Object({ account_id: Type.String() }) }, (g) => {
    g.get("/routes", {
      ...
      .response(TunnelTeamnetResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.post("/routes", {
      ...
      .response(TunnelRouteResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/routes/ip/{ip}", {
      ...
      .response(TunnelTeamnetResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/virtual_networks", {
      ...
      .response(TunnelVnetResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.post("/virtual_networks", {
      ...
      .response(TunnelVnetResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
