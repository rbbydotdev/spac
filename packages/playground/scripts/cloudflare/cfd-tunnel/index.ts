...
export function registerCfdTunnel(api: Api) {
  api.assertVersion("3.0.3", "CfdTunnel")
  ...
  api.group("/accounts/{account_id}/cfd_tunnel", { params: Type.Object({ account_id: Type.String() }) }, (g) => {
    g.get("/", {
      ...
      .response(TunnelTunnelResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.post("/", {
      ...
      .response(TunnelTunnelResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/{tunnel_id}/configurations", {
      ...
      .response(TunnelConfigurationResponse)
      .error("4XX", TunnelSchemasApiResponseCommonFailure)
    ...
    g.get("/{tunnel_id}/connections", {
      ...
      .response(TunnelTunnelConnectionsResponse)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/{tunnel_id}/connectors/{connector_id}", {
      ...
      .response(TunnelTunnelClientResponse)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.post("/{tunnel_id}/management", {
      ...
      .response(TunnelTunnelResponseToken)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
