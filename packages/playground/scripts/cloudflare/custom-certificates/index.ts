...
export function registerCustomCertificates(api: Api) {
  api.assertVersion("3.0.3", "CustomCertificates")
  ...
  api.group("/zones/{zone_id}/custom_certificates", { params: Type.Object({ zone_id: Type.String() }) }, (g) => {
    g.get("/", {
      ...
      .response(TlsCertificatesAndHostnamesCertificateResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.post("/", {
      ...
      .response(TlsCertificatesAndHostnamesCertificateResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
