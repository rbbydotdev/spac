...
export function registerApiGateway(api: Api) {
  api.assertVersion("3.0.3", "ApiGateway")
  ...
  api.group("/zones/{zone_id}/api_gateway", { params: Type.Object({ zone_id: Type.String() }) }, (g) => {
    g.get("/configuration", {
      ...
      .response(ApiShieldConfigurationSingleResponse)
      .error("4XX", ApiShieldApiResponseCommonFailure)
    ...
    g.put("/configuration", {
      ...
      .response(ApiShieldApiResponseCommon)
      .error("4XX", ApiShieldApiResponseCommonFailure)
    ...
    g.get("/discovery", {})
      .response(ApiShieldSchemaResponseDiscovery)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.patch("/discovery/operations", {
      ...
      .response(ApiShieldPatchDiscoveriesResponse)
      .error("4XX", ApiShieldApiResponseCommonFailure)
    ...
    g.patch("/discovery/operations/{operation_id}", {
      ...
      .response(ApiShieldPatchDiscoveryResponse)
      .error("4XX", ApiShieldApiResponseCommonFailure)
    ...
    g.get("/operations", {
      ...
      .response(ApiShieldMultipleOperationResponsePaginated)
      .error("4XX", ApiShieldApiResponseCommonFailure)
    ...
    g.post("/operations", {
      ...
      .response(ApiShieldMultipleOperationResponse)
      .error("4XX", ApiShieldApiResponseCommonFailure)
    ...
    g.post("/operations/item", {
      ...
      .response(ApiShieldSingleOperationResponse)
      .error("4XX", ApiShieldApiResponseCommonFailure)
    ...
    g.get("/operations/{operation_id}/schema_validation", {
      ...
      .response(ApiShieldOperationSchemaValidationSettings)
      .error("4XX", ApiShieldApiResponseCommonFailure)
    ...
    g.get("/schemas", {
      ...
      .response(ApiShieldSchemaResponseWithThresholds)
      .error("4XX", ApiShieldApiResponseCommonFailure)
    ...
    g.get("/settings/schema_validation", {})
      .response(ApiShieldZoneSchemaValidationSettings)
      .error("4XX", ApiShieldApiResponseCommonFailure)
    ...
    g.post("/user_schemas", {})
      ...
      .error("4XX", ApiShieldSchemaUploadFailure)
    ...
    g.delete("/user_schemas/{schema_id}", {
      ...
      .response(ApiShieldApiResponseSingle)
      .error("4XX", ApiShieldApiResponseCommonFailure)
