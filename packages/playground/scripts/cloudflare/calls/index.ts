...
export function registerCalls(api: Api) {
  api.assertVersion("3.0.3", "Calls")

  api.group("/accounts/{account_id}/calls", { params: Type.Object({ account_id: Type.String() }) }, (g) => {
    g.get("/apps", {})
      .response(CallsAppResponseCollection)
      .error("4XX", CallsApiResponseCommonFailure)
      .summary("List apps")
    ...
    g.post("/apps", {
      ...
      .respond(201, CallsAppResponseSingleWithSecret)
    ...
    g.get("/turn_keys", {})
      .response(CallsTurnKeyCollection)
      .error("4XX", CallsApiResponseCommonFailure)
    ...
    g.post("/turn_keys", {
      ...
      .respond(201, CallsTurnKeySingleWithSecret)
