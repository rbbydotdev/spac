...
export function registerDnsRecords(api: Api) {
  api.assertVersion("3.0.3", "DnsRecords")
  ...
  api.group("/zones/{zone_id}/dns_records", { params: Type.Object({ zone_id: Type.String() }) }, (g) => {
    g.get("/", {
      ...
      .response(DnsRecordsDnsResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.post("/", {
      ...
      .response(DnsRecordsDnsResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.post("/batch", {
      ...
      .response(DnsRecordsDnsResponseBatch)
      .error("4XX", DnsRecordsApiResponseCommonFailure)
    ...
    g.post("/import", {})
      .response(DnsRecordsDnsResponseImportScan)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.post("/scan/review", {
      ...
      .response(DnsRecordsDnsResponseReviewScan)
      .error("4XX", DnsRecordsApiResponseCommonFailure)
    ...
    g.post("/scan/trigger", {})
      .response(DnsRecordsDnsResponseTriggerScan)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
