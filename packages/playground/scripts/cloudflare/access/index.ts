...
export function registerAccess(api: Api) {
  api.assertVersion("3.0.3", "Access")
  ...
  api.group("/accounts/{account_id}/access", { params: Type.Object({ account_id: Type.String() }) }, (g) => {
    ...
    g.get("/bookmarks", {})
      .response(AccessBookmarksComponentsSchemasResponseCollection)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/bookmarks/{bookmark_id}", {
      ...
      .response(AccessBookmarksComponentsSchemasSingleResponse)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/custom_pages", {
      ...
      .response(AccessCustomPagesComponentsSchemasResponseCollection)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.post("/custom_pages", {
      ...
      .respond(201, AccessSingleResponseWithoutHtml)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/custom_pages/{custom_page_id}", {
      ...
      .response(AccessCustomPagesComponentsSchemasSingleResponse)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.put("/custom_pages/{custom_page_id}", {
      ...
      .response(AccessSingleResponseWithoutHtml)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/gateway_ca", {})
      .response(AccessGatewayCaComponentsSchemasResponseCollection)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.post("/gateway_ca", {})
      .respond(201, AccessGatewayCaComponentsSchemasSingleResponse)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/identity_providers/{identity_provider_id}/scim/groups", {
      ...
      .response(AccessScimGroupsResponse)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/identity_providers/{identity_provider_id}/scim/users", {
      ...
      .response(AccessScimUsersResponse)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/keys", {})
      .response(AccessKeysComponentsSchemasSingleResponse)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/logs/access_requests", {
      ...
      .response(AccessAccessRequestsComponentsSchemasResponseCollection)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/logs/scim/updates", {
      ...
      .response(AccessScimUpdateLogsResponse)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/policies", {
      ...
      .response(AccessReusablePoliciesComponentsSchemasResponseCollection)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.post("/policies", {
      ...
      .respond(201, AccessReusablePoliciesComponentsSchemasSingleResponse)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/policies/{policy_id}", {
      ...
      .response(AccessReusablePoliciesComponentsSchemasSingleResponse)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.delete("/policies/{policy_id}", {
      ...
      .respond(202, AccessReusablePoliciesComponentsSchemasIdResponse)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.post("/policy-tests", {
      ...
      .response(AccessPolicyInitResp)
      .error(400, AccessApiResponseCommonFailure)
    ...
    g.get("/policy-tests/{policy_test_id}", {
      ...
      .response(AccessPolicyUpdateResp)
      .error(400, AccessApiResponseCommonFailure)
    ...
    g.get("/policy-tests/{policy_test_id}/users", {
      ...
      .response(AccessPolicyUsersResp)
      .error(400, AccessApiResponseCommonFailure)
    ...
    g.patch("/seats", {
      ...
      .response(AccessSeatsComponentsSchemasResponseCollection)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/tags", {
      ...
      .response(AccessTagsComponentsSchemasResponseCollection)
      .error("4XX", AccessApiResponseCommonFailure)
      .summary("List tags")
    ...
    g.post("/tags", {
      ...
      .respond(201, AccessTagsComponentsSchemasSingleResponse)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/tags/{tag_name}", {
      ...
      .response(AccessTagsComponentsSchemasSingleResponse)
      .error("4XX", AccessApiResponseCommonFailure)
      .summary("Get a tag")
    ...
    g.delete("/tags/{tag_name}", {
      ...
      .respond(202, AccessNameResponse)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/users", {
      ...
      .response(AccessUsersComponentsSchemasResponseCollection)
      .error("4XX", AccessApiResponseCommonFailure)
      .summary("Get users")
    ...
    g.get("/users/{user_id}/active_sessions", {
      ...
      .response(AccessActiveSessionsResponse)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/users/{user_id}/active_sessions/{nonce}", {
      ...
      .response(AccessActiveSessionResponse)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/users/{user_id}/failed_logins", {
      ...
      .response(AccessFailedLoginResponse)
      .error("4XX", AccessApiResponseCommonFailure)
    ...
    g.get("/users/{user_id}/last_seen_identity", {
      ...
      .response(AccessLastSeenIdentityResponse)
      .error("4XX", AccessApiResponseCommonFailure)
