...
export function registerFilters(api: Api) {
  api.assertVersion("3.0.3", "Filters")
  ...
  api.group("/zones/{zone_id}/filters", { params: Type.Object({ zone_id: Type.String() }) }, (g) => {
    g.get("/", {
      ...
      .response(FirewallFilterResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.delete("/", {
      ...
      .response(FirewallFilterDeleteResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/{filter_id}", {
      ...
      .response(FirewallFilterResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.delete("/{filter_id}", {
      ...
      .response(FirewallFilterDeleteResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
