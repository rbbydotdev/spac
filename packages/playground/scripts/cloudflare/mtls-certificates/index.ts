...
export function registerMtlsCertificates(api: Api) {
  api.assertVersion("3.0.3", "MtlsCertificates")

  api.group("/accounts/{account_id}/mtls_certificates", { params: Type.Object({ account_id: Type.String() }) }, (g) => {
    g.get("/", {})
      .response(TlsCertificatesAndHostnamesMtlsManagementComponentsSchemasCertificateResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.post("/", {
      ...
      .response(TlsCertificatesAndHostnamesCertificateResponseSinglePost)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.get("/{mtls_certificate_id}", {
      ...
      .response(TlsCertificatesAndHostnamesMtlsManagementComponentsSchemasCertificateResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.get("/{mtls_certificate_id}/associations", {
      ...
      .response(TlsCertificatesAndHostnamesAssociationResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
