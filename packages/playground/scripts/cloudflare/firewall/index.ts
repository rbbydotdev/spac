...
export function registerFirewall(api: Api) {
  api.assertVersion("3.0.3", "Firewall")
  ...
  api.group("/zones/{zone_id}/firewall", { params: Type.Object({ zone_id: Type.String() }) }, (g) => {
    g.get("/lockdowns", {
      ...
      .response(FirewallZonelockdownResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.post("/lockdowns", {
      ...
      .response(FirewallZonelockdownResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/rules", {
      ...
      .response(FirewallFilterRulesResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/rules/{rule_id}", {
      ...
      .response(FirewallFilterRulesSingleResponse)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/ua_rules", {
      ...
      .response(FirewallFirewalluablockResponseCollection)
      .error(
        "4XX",
        Type.Object({
          result: Type.Union([Type.Null()]),
    ...
    g.post("/ua_rules", {
      ...
      .response(FirewallFirewalluablockResponseSingle)
      .error(
        "4XX",
        Type.Object({
          result: Type.Union([Type.Null()]),
    ...
    g.get("/waf/overrides", {
      ...
      .response(FirewallOverrideResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.post("/waf/overrides", {
      ...
      .response(FirewallOverrideResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/waf/packages", {
      ...
      .response(FirewallPackageResponseCollection)
      .error(
        "4XX",
        Type.Union([
          FirewallApiResponseCollection,
    ...
    g.get("/waf/packages/{package_id}", {
      ...
      .response(FirewallPackageResponseSingle)
      .error(
        "4XX",
        Type.Union([
          FirewallApiResponseSingle,
    ...
    g.get("/waf/packages/{package_id}/groups", {
      ...
      .response(WafManagedRulesRuleGroupResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/waf/packages/{package_id}/groups/{group_id}", {
      ...
      .response(WafManagedRulesRuleResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/waf/packages/{package_id}/rules", {
      ...
      .response(WafManagedRulesRuleResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
