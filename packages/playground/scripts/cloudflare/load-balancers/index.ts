...
export function registerLoadBalancers(api: Api) {
  ...
  api
    ...
    .response(LoadBalancingMonitorGroupSingleResponse)
    .error(
      412,
      Type.Object({
        errors: D1Messages,
  ...
  api
    ...
    .response(LoadBalancingRegionComponentsSchemasResponseCollection)
    .error(
      "4XX",
      Type.Object({
        errors: D1Messages,
  ...
  api
    ...
    .response(LoadBalancingComponentsSchemasSingleResponse)
    .error(
      "4XX",
      Type.Object({
        errors: D1Messages,
        ...
        result: Type.Union([Type.Null()], { description: "A list of countries and subdivisions mapped to a region." }),
      }),
    )
    .summary("Get Region")
  ...
  api
    ...
    .response(LoadBalancingLoadBalancerComponentsSchemasResponseCollection)
    .error(
      "4XX",
      Type.Object({
        errors: D1Messages,
  ...
  api
    ...
    .response(LoadBalancingLoadBalancerComponentsSchemasSingleResponse)
    .error(
      "4XX",
      Type.Object({
        errors: D1Messages,
  ...
  api
    ...
    .response(LoadBalancingComponentsSchemasIdResponse)
    .error(
      "4XX",
      Type.Object({
        errors: D1Messages,
