...
export function registerPages(api: Api) {
  ...
  api.group("/accounts/{account_id}/pages/projects", { params: Type.Object({ account_id: Type.String() }) }, (g) => {
    ...
    g.delete("/{project_name}", {
      ...
      .error("4XX", PagesApiResponseCommonFailure)
    ...
    g.post("/{project_name}/deployments", {
      ...
      .response(PagesDeploymentNewDeployment)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/{project_name}/deployments/{deployment_id}/history/logs", {
      ...
      .response(PagesDeploymentResponseLogs)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/{project_name}/domains", {
      ...
      .response(PagesDomainResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.post("/{project_name}/domains", {
      ...
      .response(PagesDomainResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
