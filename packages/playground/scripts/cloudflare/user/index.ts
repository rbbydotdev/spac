...
export function registerUser(api: Api) {
  api.assertVersion("3.0.3", "User")

  api.group("/user", (g) => {
    g.get("/", {})
      .response(IamSingleUserResponse)
    ...
    g.get("/billing/history", {
      ...
      .response(BillSubsApiBillingHistoryCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/firewall/access_rules/rules", {
      ...
      .response(FirewallRuleCollectionResponse)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.post("/firewall/access_rules/rules", {
      ...
      .response(FirewallRuleSingleResponse)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.delete("/firewall/access_rules/rules/{rule_id}", {
      ...
      .response(FirewallRuleSingleIdResponse)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/invites", {})
      .response(IamSchemasCollectionInviteResponse)
      .error("4XX", IamApiResponseCommonFailure)
    ...
    g.get("/invites/{invite_id}", {
      ...
      .response(IamSingleInviteResponse)
      .error("4XX", IamApiResponseCommonFailure)
    ...
    g.get("/load_balancers/monitors", {})
      .response(LoadBalancingMonitorResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.post("/load_balancers/monitors", {
      ...
      .response(LoadBalancingMonitorResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.delete("/load_balancers/monitors/{monitor_id}", {
      ...
      .response(LoadBalancingIdResponse)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.post("/load_balancers/monitors/{monitor_id}/preview", {
      ...
      .response(LoadBalancingPreviewResponse)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/load_balancers/monitors/{monitor_id}/references", {
      ...
      .response(LoadBalancingMonitorReferencesResponse)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/load_balancers/pools", {
      ...
      .response(LoadBalancingSchemasResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.post("/load_balancers/pools", {
      ...
      .response(LoadBalancingSchemasSingleResponse)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.delete("/load_balancers/pools/{pool_id}", {
      ...
      .response(LoadBalancingSchemasIdResponse)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/load_balancers/pools/{pool_id}/health", {
      ...
      .response(LoadBalancingHealthDetails)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/load_balancers/pools/{pool_id}/references", {
      ...
      .response(LoadBalancingPoolsReferencesResponse)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/load_balancers/preview/{preview_id}", {
      ...
      .response(LoadBalancingPreviewResultResponse)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/load_balancing_analytics/events", {
      ...
      .response(LoadBalancingComponentsSchemasResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/organizations", {
      ...
      .response(IamCollectionOrganizationResponse)
      .error("4XX", IamApiResponseCommonFailure)
    ...
    g.get("/organizations/{organization_id}", {
      ...
      .response(Type.Unknown() /* unresolved: #/components/schemas/iam_single_organization_response */)
      .error("4XX", IamApiResponseCommonFailure)
    ...
    g.get("/subscriptions", {})
      .response(BillSubsApiUserSubscriptionResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.put("/subscriptions/{identifier}", {
      ...
      .response(BillSubsApiUserSubscriptionResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
