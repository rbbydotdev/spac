...
export function registerContentUploadScan(api: Api) {
  api.assertVersion("3.0.3", "ContentUploadScan")

  api.group("/zones/{zone_id}/content-upload-scan", { params: Type.Object({ zone_id: Type.String() }) }, (g) => {
    g.post("/disable", {})
      .response(WafProductApiBundleSchemasApiResponseCommon)
      .error("4XX", WafProductApiBundleSchemasApiResponseCommonFailure)
    ...
    g.get("/payloads", {})
      .response(WafProductApiBundleResponseCustomScanCollection)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/settings", {})
      .response(WafProductApiBundleSchemasResponseStatus)
      .error("4XX", WafProductApiBundleSchemasApiResponseCommonFailure)
