...
export function registerSpeedApi(api: Api) {
  api.assertVersion("3.0.3", "SpeedApi")

  api.group("/zones/{zone_id}/speed_api", { params: Type.Object({ zone_id: Type.String() }) }, (g) => {
    g.get("/availabilities", {})
      .response(ObservatoryAvailabilitiesResponse)
      .error("4XX", ObservatoryApiResponseCommonFailure)
    ...
    g.get("/pages", {})
      .response(ObservatoryPagesResponseCollection)
      .error("4XX", ObservatoryApiResponseCommonFailure)
    ...
    g.get("/pages/{url}/tests", {
      ...
      .response(ObservatoryPageTestResponseCollection)
      .error("4XX", ObservatoryApiResponseCommonFailure)
    ...
    g.post("/pages/{url}/tests", {
      ...
      .response(ObservatoryPageTestResponseSingle)
      .error("4XX", ObservatoryApiResponseCommonFailure)
    ...
    g.delete("/pages/{url}/tests", {
      ...
      .response(ObservatoryCountResponse)
      .error("4XX", ObservatoryApiResponseCommonFailure)
    ...
    g.get("/pages/{url}/trend", {
      ...
      .response(ObservatoryTrendResponse)
      .error("4XX", ObservatoryApiResponseCommonFailure)
    ...
    g.get("/schedule/{url}", {
      ...
      .response(ObservatoryScheduleResponseSingle)
      .error("4XX", ObservatoryApiResponseCommonFailure)
    ...
    g.post("/schedule/{url}", {
      ...
      .response(ObservatoryCreateScheduleResponse)
      .error("4XX", ObservatoryApiResponseCommonFailure)
