...
export function registerPageShield(api: Api) {
  api.assertVersion("3.0.3", "PageShield")
  ...
  api.group("/zones/{zone_id}/page_shield", { params: Type.Object({ zone_id: Type.String() }) }, (g) => {
    g.get("/", {})
      ...
      .error("4XX", PageShieldApiResponseCommonFailure)
    ...
    g.get("/connections", {
      ...
      .response(PageShieldListZoneConnectionsResponse)
      .error("4XX", PageShieldApiResponseCommonFailure)
    ...
    g.get("/connections/{connection_id}", {
      ...
      .response(PageShieldGetZoneConnectionResponse)
      .error("4XX", PageShieldApiResponseCommonFailure)
    ...
    g.get("/cookies", {
      ...
      .response(PageShieldListZoneCookiesResponse)
      .error("4XX", PageShieldApiResponseCommonFailure)
    ...
    g.get("/cookies/{cookie_id}", {
      ...
      .response(PageShieldGetZoneCookieResponse)
      .error("4XX", PageShieldApiResponseCommonFailure)
    ...
    g.get("/policies", {})
      .response(PageShieldListZonePoliciesResponse)
      .error("4XX", PageShieldApiResponseCommonFailure)
    ...
    g.post("/policies", {
      ...
      .response(PageShieldGetZonePolicyResponse)
      .error("4XX", PageShieldApiResponseCommonFailure)
    ...
    g.get("/scripts", {
      ...
      .response(PageShieldListZoneScriptsResponse)
      .error("4XX", PageShieldApiResponseCommonFailure)
    ...
    g.get("/scripts/{script_id}", {
      ...
      .response(PageShieldGetZoneScriptResponse)
      .error("4XX", PageShieldApiResponseCommonFailure)
