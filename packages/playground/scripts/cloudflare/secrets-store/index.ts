...
export function registerSecretsStore(api: Api) {
  api.assertVersion("3.0.3", "SecretsStore")

  api.group("/accounts/{account_id}/secrets_store", { params: Type.Object({ account_id: Type.String() }) }, (g) => {
    g.get("/quota", {})
      .response(SecretsStoreQuotaResponse)
      .error("4XX", SecretsStoreApiResponseCommonFailure)
    ...
    g.get("/stores", {
      ...
      .response(SecretsStoreStoresResponseCollection)
      .error("4XX", SecretsStoreApiResponseCommonFailure)
    ...
    g.delete("/stores/{store_id}", {
      ...
      .response(SecretsStoreStoreResponse)
      .error("4XX", SecretsStoreApiResponseCommonFailure)
    ...
    g.get("/stores/{store_id}/secrets", {
      ...
      .response(SecretsStoreSecretsResponseCollection)
      .error("4XX", SecretsStoreApiResponseCommonFailure)
    ...
    g.get("/stores/{store_id}/secrets/{secret_id}", {
      ...
      .response(SecretsStoreSecretResponse)
      .error("4XX", SecretsStoreApiResponseCommonFailure)
