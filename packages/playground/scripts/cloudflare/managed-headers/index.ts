...
import { RulesetsManagedtransforms } from "./schemas"

export function registerManagedHeaders(api: Api) {
  api.assertVersion("3.0.3", "ManagedHeaders")

  api.group("/zones/{zone_id}/managed_headers", { params: Type.Object({ zone_id: Type.String() }) }, (g) => {
    g.get("/", {})
      .response(
        Type.Object(
          {
            ...
            result: RulesetsManagedtransforms,
    ...
    g.patch("/", {
      body: RulesetsManagedtransforms,
    })
      .response(
        Type.Object(
          {
