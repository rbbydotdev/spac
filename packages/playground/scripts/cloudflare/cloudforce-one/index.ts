...
export function registerCloudforceOne(api: Api) {
  api.assertVersion("3.0.3", "CloudforceOne")
  ...
  api.group("/accounts/{account_id}/cloudforce-one", { params: Type.Object({ account_id: Type.String() }) }, (g) => {
    ...
    g.post("/events/create/bulk", {
      ...
      .response(Type.Number({ description: "Number of created bulk events" }))
      .error(
        400,
        Type.Object({
          errors: Type.Array(
    ...
    g.post("/events/indicators/bulk", {
      ...
      .response(Type.Number({ description: "Number of created indicators" }))
      .error(
        400,
        Type.Object({
          errors: Type.Array(
    ...
    g.get("/events/indicators/{indicator_type}/tags", {
      ...
      .response(Type.Array(Type.Unknown(), { description: "Array of mirror tag rows" }))
      .error(
        400,
        Type.Object({
          errors: Type.Array(
    ...
    g.delete("/events/{dataset_id}/delete", {
      ...
      .response(Type.Number({ description: "Number of deleted events" }))
      .error(
        400,
        Type.Object({
          errors: Type.Array(
    ...
    g.post("/requests", {
      ...
      .error("4XX", CloudforceOneRequestsApiResponseCommonFailure)
    ...
    g.delete("/requests/priority/{priority_id}", {
      ...
      .response(CloudforceOneRequestsApiResponseCommon)
      .error("4XX", CloudforceOneRequestsApiResponseCommonFailure)
    ...
    g.get("/scans/config", {})
      ...
      .error("4XX", CloudforceOnePortScanApiApiResponseCommonFailure)
