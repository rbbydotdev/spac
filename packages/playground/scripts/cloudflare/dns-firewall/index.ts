...
export function registerDnsFirewall(api: Api) {
  api.assertVersion("3.0.3", "DnsFirewall")
  ...
  api.group("/accounts/{account_id}/dns_firewall", { params: Type.Object({ account_id: Type.String() }) }, (g) => {
    g.get("/", {
      ...
      .response(DnsFirewallDnsFirewallResponseCollection)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.post("/", {
      ...
      .response(DnsFirewallDnsFirewallSingleResponse)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
    ...
    g.get("/{dns_firewall_id}/reverse_dns", {
      ...
      .response(DnsFirewallDnsFirewallReverseDnsResponse)
      .error(
        "4XX",
        Type.Object({
          errors: DlpMessages,
