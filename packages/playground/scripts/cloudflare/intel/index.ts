...
export function registerIntel(api: Api) {
  ...
  api.group("/accounts/{account_id}/intel", { params: Type.Object({ account_id: Type.String() }) }, (g) => {
    ...
    g.get("/dns", {
      ...
      .response(IntelComponentsSchemasSingleResponse)
      .error(
        "4XX",
        Type.Object({
          errors: Type.Array(
    ...
    g.get("/domain/bulk", {
      ...
      .response(IntelCollectionResponse)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.get("/indicator-feeds", {})
      .response(CustomIndicatorFeedsIndicatorFeedResponse)
      .error(
        "4XX",
        Type.Object({
          errors: Type.Array(
    ...
    g.post("/indicator-feeds", {
      ...
      .response(CustomIndicatorFeedsCreateFeedResponse)
      .error(
        "4XX",
        Type.Object({
          errors: Type.Array(
    ...
    g.put("/indicator-feeds/permissions/add", {
      ...
      .response(CustomIndicatorFeedsPermissionsResponse)
      .error(
        "4XX",
        Type.Object({
          errors: Type.Array(
    ...
    g.get("/indicator-feeds/permissions/view", {})
      .response(CustomIndicatorFeedsPermissionListItemResponse)
      .error(
        "4XX",
        Type.Object({
          errors: Type.Array(
    ...
    g.get("/indicator-feeds/{feed_id}", {
      ...
      .response(CustomIndicatorFeedsIndicatorFeedMetadataResponse)
      .error(
        "4XX",
        Type.Object({
          errors: Type.Array(
    ...
    g.get("/indicator-feeds/{feed_id}/data", {
      ...
      .error("4XX", CustomIndicatorFeedsApiResponseCommonFailure)
    ...
    g.get("/indicator-feeds/{feed_id}/download", {
      ...
      .response(CustomIndicatorFeedsUpdateFeedResponse)
      .error("4XX", CustomIndicatorFeedsApiResponseCommonFailure)
    ...
    g.get("/ip-list", {})
      .response(IntelComponentsSchemasResponse)
      .error(
        "4XX",
        Type.Object({
          errors: D1Messages,
    ...
    g.post("/miscategorization", {
      ...
      .response(IntelApiResponseSingle)
      .error(
        "4XX",
        Type.Object({
          errors: Type.Array(
    ...
    g.get("/whois", {
      ...
      .response(CloudforceOneWhoisSchemasSingleResponse)
      .error(
        "4XX",
        Type.Object({
          errors: Type.Array(
