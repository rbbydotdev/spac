...
export function registerBrandProtection(api: Api) {
  api.assertVersion("3.0.3", "BrandProtection")
  ...
  api.group("/accounts/{account_id}/brand-protection", { params: Type.Object({ account_id: Type.String() }) }, (g) => {
    ...
    g.get("/logo-matches", {
      ...
      .response(BrandProtectionApiLogomatch)
      .error(422, BrandProtectionApiError)
      .error("default", BrandProtectionApiError)
    ...
    g.post("/logos", {
      ...
      .respond(201, BrandProtectionApiLogo)
      .error(422, BrandProtectionApiError)
      .error("default", BrandProtectionApiError)
    ...
    g.post("/submit", {})
      .respond(201, BrandProtectionApiUrlsubmit)
      .error("default", BrandProtectionApiError)
    ...
    g.get("/url-info", {})
      .response(BrandProtectionApiUrlinfo)
      .error("default", BrandProtectionApiError)
