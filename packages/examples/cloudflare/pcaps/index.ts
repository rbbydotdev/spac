...
export function registerPcaps(api: Api) {
  api.group("/accounts/{account_id}/pcaps", { params: Type.Object({ account_id: Type.String() }) }, (g) => {
    g.get("/", {
      responses: {
        200: MagicVisibilityPcapsPcapsCollectionResponse,
        default: Type.Union([
          MagicVisibilityPcapsPcapsCollectionResponse,
          MagicVisibilityPcapsApiResponseCommonFailure,
        ]),
    ...
    g.post("/", {
      ...
      responses: {
        200: MagicVisibilityPcapsPcapsSingleResponse,
        default: Type.Union([MagicVisibilityPcapsPcapsSingleResponse, MagicVisibilityPcapsApiResponseCommonFailure]),
      },
    })
    ...
    g.get("/ownership", {
      responses: {
        200: MagicVisibilityPcapsPcapsOwnershipCollection,
        default: Type.Union([
          MagicVisibilityPcapsPcapsOwnershipCollection,
          MagicVisibilityPcapsApiResponseCommonFailure,
        ]),
    ...
    g.post("/ownership", {
      ...
      responses: {
        200: MagicVisibilityPcapsPcapsOwnershipSingleResponse,
        default: Type.Union([
          MagicVisibilityPcapsPcapsOwnershipSingleResponse,
          MagicVisibilityPcapsApiResponseCommonFailure,
        ]),
    ...
    g.put("/{pcap_id}/stop", {
      params: Type.Object({ pcap_id: MagicVisibilityPcapsIdentifier }),
      responses: {
        default: MagicVisibilityPcapsApiResponseCommonFailure,
      },
    })
