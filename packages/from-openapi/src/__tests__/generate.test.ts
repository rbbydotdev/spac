...
describe("generate", () => {
  ...
  it("index.ts imports groups and has setup", async () => {
    ...
    expect(index).toContain('new Api("3.1", "Pet Store"');
  ...
  describe("dependency ordering with dedup aliases", () => {
    it("emits schemas in dependency order when refs go through dedup aliases", async () => {
      const spec = {
            ...
            get: {
              responses: {
                "200": {
                  content: {
                    "application/json": {
                      schema: { $ref: "#/components/schemas/base_alias" },
                    },
                  },
                },
              },
        ...
        components: {
          schemas: {
            ...
            wrapper: {
              type: "object",
              properties: { ts: { $ref: "#/components/schemas/base_alias" } },
            },
          },
        },
      };
      ...
      const allSchemaFiles = Array.from(files.entries()).filter(([k]) =>
            ...
            get: {
              ...
              responses: {
                "200": {
                  content: {
                    "application/json": {
                      schema: { $ref: "#/components/schemas/aaa_response" },
                    },
                  },
                },
              },
            ...
            get: {
              ...
              responses: {
                "200": {
                  content: {
                    "application/json": {
                      schema: { $ref: "#/components/schemas/bbb_response" },
                    },
                  },
                },
              },
